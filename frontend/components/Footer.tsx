            ...
            <div className="flex gap-3 mt-4 sm:justify-end">
              {socials.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="w-9 h-9 flex items-center justify-center rounded-full bg-white/5 border border-[#F0C4B7]/15 text-white/60 hover:text-[#F0C4B7] hover:border-[#F0C4B7]/40 transition-colors"
                >
